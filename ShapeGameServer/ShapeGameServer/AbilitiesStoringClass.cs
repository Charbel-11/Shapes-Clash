...
class AbilitiesStoringClass
{
    ...
    public static void InitializeAbilitiesArray()
    {
        ...
        Super100ShopArray[0][0] = new int[3] { 1000, 50, 4 };
        Super100ShopArray[0][1] = new int[3] { 2000, 75, 6 };
        Super100ShopArray[0][2] = new int[3] { 4000, 100, 8 };
        Super100ShopArray[1] = new int[3][];
        Super100ShopArray[1][0] = new int[3] { 1000, 50, 4 };
        Super100ShopArray[1][1] = new int[3] { 2000, 75, 6 };
        Super100ShopArray[1][2] = new int[3] { 4000, 100, 8 };
        Super100ShopArray[2] = new int[3][];
        Super100ShopArray[2][0] = new int[3] { 1000, 50, 4 };
        Super100ShopArray[2][1] = new int[3] { 2000, 75, 6 };
        Super100ShopArray[2][2] = new int[3] { 4000, 100, 8 };
        Super100ShopArray[3] = new int[3][];
        Super100ShopArray[3][0] = new int[3] { 1000, 50, 4 };
        Super100ShopArray[3][1] = new int[3] { 2000, 75, 6 };
        Super100ShopArray[3][2] = new int[3] { 4000, 100, 8 };
        #endregion
        #region Super200ShopArray
        Super200ShopArray[0] = new int[3][];
        Super200ShopArray[0][0] = new int[3] { 1000, 50, 4 };
        Super200ShopArray[0][1] = new int[3] { 2000, 75, 6 };
        Super200ShopArray[0][2] = new int[3] { 4000, 100, 8 };
        Super200ShopArray[1] = new int[3][];
        Super200ShopArray[1][0] = new int[3] { 1000, 50, 4 };
        Super200ShopArray[1][1] = new int[3] { 2000, 75, 6 };
        Super200ShopArray[1][2] = new int[3] { 4000, 100, 8 };
        Super200ShopArray[2] = new int[3][];
        Super200ShopArray[2][0] = new int[3] { 1000, 50, 4 };
        Super200ShopArray[2][1] = new int[3] { 2000, 75, 6 };
        Super200ShopArray[2][2] = new int[3] { 4000, 100, 8 };
        Super200ShopArray[3] = new int[3][];
        Super200ShopArray[3][0] = new int[3] { 1000, 50, 4 };
        Super200ShopArray[3][1] = new int[3] { 2000, 75, 6 };
        Super200ShopArray[3][2] = new int[3] { 4000, 100, 8 };
        #endregion
        #region PassivesShopArray
        PassivesShopArray[0] = new int[3][];
        PassivesShopArray[0][0] = new int[3] { 500, 20, 2 };
        PassivesShopArray[0][1] = new int[3] { 1000, 30, 4 };
        PassivesShopArray[0][2] = new int[3] { 1500, 50, 8 };
        PassivesShopArray[1] = new int[3][];
        PassivesShopArray[1][0] = new int[3] { 500, 20, 2 };
        PassivesShopArray[1][1] = new int[3] { 1000, 30, 4 };
        PassivesShopArray[1][2] = new int[3] { 1500, 50, 8 };
        PassivesShopArray[2] = new int[3][];
        PassivesShopArray[2][0] = new int[3] { 500, 20, 2 };
        PassivesShopArray[2][1] = new int[3] { 1000, 30, 4 };
        PassivesShopArray[2][2] = new int[3] { 1500, 50, 8 };
        PassivesShopArray[3] = new int[3][];
        PassivesShopArray[3][0] = new int[3] { 500, 20, 2 };
        PassivesShopArray[3][1] = new int[3] { 1000, 30, 4 };
        PassivesShopArray[3][2] = new int[3] { 1500, 50, 8 };
        PassivesShopArray[4] = new int[3][];
        PassivesShopArray[4][0] = new int[3] { 500, 20, 2 };
        PassivesShopArray[4][1] = new int[3] { 1000, 30, 4 };
        PassivesShopArray[4][2] = new int[3] { 1500, 50, 8 };
        PassivesShopArray[4] = new int[3][];
        PassivesShopArray[4][0] = new int[3] { 500, 20, 2 };
        PassivesShopArray[4][1] = new int[3] { 1000, 30, 4 };
        PassivesShopArray[4][2] = new int[3] { 1500, 50, 8 };
        PassivesShopArray[5] = new int[3][];
        PassivesShopArray[5][0] = new int[3] { 500, 20, 2 };
        PassivesShopArray[5][1] = new int[3] { 1000, 30, 4 };
        PassivesShopArray[5][2] = new int[3] { 1500, 50, 8 };
        PassivesShopArray[6] = new int[3][];
        PassivesShopArray[6][0] = new int[3] { 500, 20, 2 };
        PassivesShopArray[6][1] = new int[3] { 1000, 30, 4 };
        PassivesShopArray[6][2] = new int[3] { 1500, 50, 8 };
        PassivesShopArray[7] = new int[3][];
        PassivesShopArray[7][0] = new int[3] { 500, 20, 2 };
        PassivesShopArray[7][1] = new int[3] { 1000, 30, 4 };
        PassivesShopArray[7][2] = new int[3] { 1500, 50, 8 };
        #endregion
        ...
        LevelStatsArray[0][4] = new int[3] { 500, 200, 10 };
        ...
        LevelStatsArray[1][4] = new int[3] { 1000, 500, 20 };
        ...
        LevelStatsArray[2][4] = new int[3] { 2000, 1000, 30 };
        ...
        LevelStatsArray[3][4] = new int[3] { 4000, 2000, 45 };
        ...
        LevelStatsArray[4][4] = new int[3] { 6000, 3000, 60 };
        ...
        LevelStatsArray[5][4] = new int[3] { 8000, 5000, 70 };
        ...
        LevelStatsArray[6][4] = new int[3] { 10000, 6000, 80 };
        ...
        LevelStatsArray[7][4] = new int[3] { 15000, 8000, 100 };
        #endregion
